---
title: ProxyU Java Client 1.1.0
---

# ProxyU Java Client 1.1.0

!!! warning "Archived documentation — SDK 1.1.0"
    You are reading the documentation for **ProxyU Java Client 1.1.0**. This release is no longer
    the current one and receives no further updates.

    The latest release is **2.0.0** — see the [current documentation](index.md).
...
This page documents release **1.1.0**.
...
| **process** | Use `b4f3e53e-7af4-46b0-8bab-5256ff420080`.                                              |
...
!!! tip "Getting the Data ID"
    ...
    - **application/datau+node**
     ...
     If you need to set the data ID dynamically based on your needs, you can use
