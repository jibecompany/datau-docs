...
!!! info dx-fit "Scan the QR code with your phone camera"
    ![DataU QR code](../assets/datau-prod-qr.png){ width="260" }
...
!!! info "My Data view"
    ![My Data view web](../assets/datau-my-data-web_framed.png){ width="75%" }
    ![My Data view mobile](../assets/datau-my-data-mobile_framed.png){ width="23%" }
    { .dx-pair-row }
...
!!! info "My Settings view"
    ![My Settings web](../assets/datau-my-settings-web_framed.png){ width="75%" }
    ![My Settings mobile](../assets/datau-my-settings-mobile_framed.png){ width="23%" }
    { .dx-pair-row }
...
![Data Processor App showing correlation link](../assets/dp-correlation_framed.png){ width="65%" }

![DashboardU decoding the correlation request](../assets/datau-correlation_framed.png){ width="65%" }
...
![Data Processor App showing permission link](../assets/dp-permission_framed.png){ width="65%" }

![DashboardU decoding the permission request](../assets/datau-permission_framed.png){ width="65%" }
